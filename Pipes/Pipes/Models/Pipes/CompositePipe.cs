...
namespace Pipes.Models.Pipes
{
    public abstract class CompositePipe : Pipe
    {
        ...
        {
            var adapterInlet =  new AdapterInlet<TMessage>(new Lazy<IPipe>(() => this), SharedResource.CreateAndConnect());
        ...
        {
            var adapterOutlet = new AdapterOutlet<TMessage>(new Lazy<IPipe>(() => this), SharedResource.CreateAndConnect());
