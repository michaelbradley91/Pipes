...
{
    [TestFixture]
    public class ValvedPipeBuilderTests
    {
        private IValvedPipeBuilder<string, int> valvedPipeBuilder;

        [SetUp]
        public void SetUp()
        {
            valvedPipeBuilder = new ValvedPipeBuilder<string, int>();
        }
        ...
        {
            // Act
            var pipe = valvedPipeBuilder.Build();
        ...
        {
            // Act
            var pipe = valvedPipeBuilder.WithAlternatingTieBreaker().Build();
        ...
        {
            // Act
            var pipe = valvedPipeBuilder.WithPrioritisingTieBreaker().Build();
        ...
        public void WithPrioritisingTieBreaker_GivenASpecificPriority_ReturnsAPipeWithThatPriority()
        {
            ...
            // Act
            var pipe = valvedPipeBuilder.WithPrioritisingTieBreaker(priority).Build();
        ...
        {
            // Act
            valvedPipeBuilder.WithRandomisingTieBreaker(-4);
        }
        ...
        {
            // Act
            valvedPipeBuilder.WithRandomisingTieBreaker(2);
        }
        ...
        {
            // Act
            var pipe = valvedPipeBuilder.WithRandomisingTieBreaker().Build();
        ...
        public void WithRandomisingTieBreaker_GivenASpecificLeftProbability_ReturnsAPipeWithThatLeftProbability()
        {
            ...
            // Act
            var pipe = valvedPipeBuilder.WithRandomisingTieBreaker(leftProbability).Build();
